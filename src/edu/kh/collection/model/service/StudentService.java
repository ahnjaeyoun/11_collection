...
public class StudentService {
	...
	public StudentService() {
		...
		studentList.add(new Student("고영희", 25, "경기도 김포시", 'F', 100 ));
		studentList.add(new Student("강아지", 25, "인천 계양구", 'm', 80 ));
		studentList.add(new Student("김모씨", 25, "서울시 노원구", 'F', 70 ));
		studentList.add(new Student("이모씨", 25, "경기도 안산시", 'm', 50 ));
	}
...
//		studentList.add(new Object()); // 3번
	...
	public void displayMenu() {
		...
		do {
			...
			try {
				...
				System.out.println("error : 입력형식이 유효하지 않습니다. 다시 시도해주세요.");
	...
	public String addStudent() throws InputMismatchException{
		...
		System.out.print("점수 : ");
		int score = sc.nextInt(); // InputMismathException
	...
	public void selectAll() {
		...
		*/
		...
		for(Student std : studentList) {
			// std에는 for문 반복 시 마다 0,1,2 .. 인덱스 요소를 한벅씩 저장됨
	...
	// 0번 : Student [name=고영희, age=25, region=경기도 김포시, gender=F, score=100]
