...
public class SetService {
	...
	public void ex1() {
		...
		// -> 대신에 Set 전제의 데이터를 하나씩 반복적으로 얻어올 순 있다!
		...
		while(it.hasNext()) { // hashNext() : 다음 값이 있으면 true 반환
	...
	// 	(Interger)	(int -> Integer) 자동 포장
		...
		// Integer + Integer -> int + int (자동 포장 해체) (AutoUnboxing)
	...
	public void lotto() {
		...
		// Integer 는 equals(), hashCode() 이미 오버라이딩 완료상태
